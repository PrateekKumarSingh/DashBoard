...
#python.exe -m pip install --upgrade google-auth google-auth-oauthlib google-auth-httplib2
#python.exe -m pip install --upgrade flask
...
from google import oauth2 #import credentials
